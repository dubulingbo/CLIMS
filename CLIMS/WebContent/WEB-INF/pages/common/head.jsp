...
<!-- The styles -->
<link
	href="/statics/css/bootstrap-cerulean.css"
	rel="stylesheet">
<style type="text/css">
body {
	padding-bottom: 40px;
	...
	<div class="navbar">
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<a class="brand" href="/main.html"> <img alt="CLIMS Logo" src="/statics/img/logo001.jpg" /><span>仪器管理系统</span></a>
				...
				<div class="btn-group pull-right" style="padding-top: 10px;">
					...
					<ul class="dropdown-menu">
						<li style="padding-left: 20px;">
							<b style="color: green;">角色</b>&nbsp;&nbsp;
							<span class="label label-success">${currentUser.userRoleName }</span>
						</li>
						<li class="divider"></li>
						<li><a href="/backend/modifyInfo.html">完善/查看个人信息</a></li>
						<li><a href="javascript:void(0)" class="btn-setting modifypwd">修改个人密码</a></li>
				...
				<div class="modal hide fade" id="myModal">
					...
					<div class="modal-body">
						<p>
							<label>请输入原密码：</label><input id="oldpassword" type="password">
							<span style="color: red; font-weight: bold;">*</span> 
							
							<label>请输入新密码：</label><input id="newpassword" type="password">
							<span style="color: red; font-weight: bold;">*新密码必须6位以上</span>
							
							<label>再次输入新密码：</label><input id="aginpassword" type="password">
							<span style="color: red; font-weight: bold;">*</span>
						</p>
						<p id="modifypwdtip"></p>
					</div>
					<div class="modal-footer">
						<a href="javascript:void(0)" class="btn modifyPwdCancel" data-dismiss="modal"> 取消</a>
						<a href="javascript:void(0)" id="modifySavePassword" class="btn btn-primary"> 修改</a>
					</div>
				</div>
		...
		<div class="row-fluid">
			...
			<div class="span2 main-menu-span">
				<div class="well nav-collapse sidebar-nav">
					...
					<label class="hidden-tablet" for="is-ajax"><b>&emsp;Menu end</b></label>
				</div> <!--/.well -->
			</div> <!--/span-->
			<!-- left menu ends -->
