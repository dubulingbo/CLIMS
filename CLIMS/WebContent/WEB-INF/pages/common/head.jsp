...
<head>
	...
	<script type="text/javascript">var pa='${pageContext.request.contextPath }';</script>	
</head>
	...
	<div class="navbar">
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<a class="brand" href="/main.html"> <img alt="Charisma Logo" src="${pageContext.request.contextPath }/statics/img/logo20.png" /> <span>SL会员商城</span></a>
				
				<!-- theme selector starts -->
				<div class="btn-group pull-right theme-container" >
					<ul class="nav">
						<li><a>你好, ${user.loginCode }</a></li>
						<li><a>角色：${user.roleName }</a></li>
