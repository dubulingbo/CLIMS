...
<div class="box-header well">
	<h2><i class="icon-th"></i> 仪器变动申请审核</h2>
</div>
				...
				<table class="table table-striped table-bordered">
					...
					<c:forEach items="${assignList }" var="assign">
						<tr>
							...
							<td class="center" id="instAssignApplyCheckStatus">
							...
							<td class="center">
								<a class="btn btn-success instAssignApplyAgree" href="javascript:void();" id="${assign.id }" status="${assign.status }"><i class="icon-ok icon-white"></i>同意</a>
								<a class="btn btn-danger instAssignApplyRefuse" href="#" id="${assign.id }" status="${assign.status }"><i class="icon-remove icon-white"></i>拒绝</a>
							</td>
						</tr>
					</c:forEach>
					</tbody>
				</table>
				<div class="pagination pagination-centered" id="instAssignApplyTable_pagination">
					<ul>
						<c:choose>
							<c:when test="${pageIndex >= 1 }">
								<li><a href="instAssignApplyTable.html?pageIndex=${pageIndex-1 }">上一页</a></li>
							</c:when>
							<c:otherwise>
						...
						<li><a href="instAssignApplyTable.html?pageIndex=${pageIndex+1 }">下一页</a></li>
					</ul>
				</div>
			</c:if>
			<c:if test="${assignList == null }">
				...
				<table class="table table-striped table-bordered">
					...
					<tbody>
						<tr>
							...
							<td class="center">
								<a class="btn btn-success" href="#"><i class="icon-ok icon-white"></i>同意</a>
								<a class="btn btn-danger" href="#"><i class="icon-remove icon-white"></i>拒绝</a>
							</td>
						</tr>
					</tbody>
				</table>
...
<div class="theme-loadpage-popover">
	...
	<div class="center"><h3>请等待，正在处理请求...</h3></div>
</div>
