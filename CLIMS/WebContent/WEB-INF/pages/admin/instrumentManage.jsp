...
<link href='${pageContext.request.contextPath }/statics/localcss/instrumentManage.css' rel='stylesheet'>
<!-- 这里编辑每个页面的导航条  starts -->
<div>
	<ul class="breadcrumb">
...
<div class="row-fluid sortable">
	<div class="box span12">
		...
		<div class="box-header well" data-original-title>
			<h2><i class="icon-list-alt"></i> 仪器信息列表</h2>
			<div class="box-icon">
		...
		<div class="box-content">
			<a href="javascript:void();" class="btn btn-large addInstrument"><i class="icon-plus"></i> 添加仪器</a>
			...
			<div class="pagination pagination-centered">
				<ul>
					<c:choose>
						...
						<c:otherwise>
							<li>
<a href='instrumentManage.html?pageIndex=1&s_instrumentName=${s_instrumentName}&s_classNo=${s_classNo}&s_dept=${s_dept}'
   title="首页">首页</a>
							</li>                                                                      
						</c:otherwise>
					</c:choose>
					<c:if test="${page.prevPages != null}">
						<c:forEach items="${page.prevPages}" var="num">
							<li>
<a href='instrumentManage.html?pageIndex=${num }&s_instrumentName=${s_instrumentName}&s_classNo=${s_classNo}&s_dept=${s_dept}'                                
...
class="number" title="${num}">${num}</a>
					...
					<c:if test="${page.totalPageCount != null}">
						<c:choose>
							...
							<c:otherwise>
								<li>
<a href='instrumentManage.html?pageIndex=${page.totalPageCount}&s_instrumentName=${s_instrumentName}&s_classNo=${s_classNo}&s_dept=${s_dept}'
   title="尾页">尾页</a>
	   							</li>                                                                      
							</c:otherwise>
						</c:choose>
		...
		<div class="box-content">
			<form action="instrumentManage.html" method="post" onsubmit="return _queryInstrumentFunction();">
				<div class="form-horizontal">
					...
					<div class="control-group">
						...
						<div class="controls">
							<select id="selectError s_classNo" data-rel="chosen" style="width:150px;" class="s_classNo" name="s_classNo">
					...
					<div class="control-group">
						...
						<div class="controls">
							<select id="selectError s_dept" data-rel="chosen" style="width:150px;" class="s_dept" name="s_dept">
								<option value="">--请选择--</option>
								<c:if test="${deptList != null }">
									<c:forEach items="${deptList }" var="dept">
										<option <c:if test="${dept.deptName == s_dept }">selected="selected"</c:if> value="${dept.deptName }">${dept.deptName }</option>
									</c:forEach>
								</c:if>
							</select>
						</div>
				...
				<div class="center">
					<a href="#" class="btn btn-large btn-primary" id="resetQueryInstrument"><i class="icon-chevron-left icon-white"></i> 重置</a>&emsp;&emsp;
...
<div class="modal hide fade" id="addInstrumentDiv">
	...
	<div class="modal-header">
		<button type="button" class="close addInstrumentCancel" data-dismiss="modal">×</button>
		<h3>添加仪器信息</h3>
	</div>
	
	<div class="modal-body">
		<form action="addInstrument.html" method="post" enctype="multipart/form-data" onsubmit="return addInstrumentFunction();">
			...
			<div class="box-content">
				<div class="form-horizontal">
					...
					<div class="control-group">
						...
						<div class="controls">
							<input class="input-xlarge focused" type="text" id="a_instrumentName" name="instrumentName" required="required">
					...
					<div class="control-group">
						...
						<div class="controls">
							<input class="input-xlarge focused" type="text" id="a_instrumentType" name="instrumentType">
						</div>
					</div>
					...
					<div class="control-group">
						...
						<div class="controls">
							<select id="selectError3 a_classNo" class="a_classNo" name="classNo" style="width:140px;">
					...
					<div class="control-group">
						...
						<div class="controls">
							<select id="selectError2 a_country" class="a_country" data-rel="chosen" name="country" style="width:140px;">
								<option value="" selected="selected">--请选择--</option>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input class="input-xlarge focused" type="text" id="a_int_price" required="required" style="width:100px;" onkeyup="value=value.replace(/[^\w\.\/]/ig,'')">
							. <input class="input-xlarge focused" type="text" id="a_float_price" maxlength="2" required="required" style="width:60px;" value="00" onkeyup="value=value.replace(/[^\w\.\/]/ig,'')">
							<span style="color:red;font-weight: bold;">*</span>
						</div>
					</div>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input class="input-xlarge focused" type="text" id="a_manufacturer" name="manufacturer" required="required">
							<span style="color:red;font-weight: bold;">*</span>
						</div>
					</div>
					...
					<div class="control-group">
						...
						<div class="controls">
							...
							onClick="WdatePicker();" id="a_productionDate" name="productionDate" 
					...
					<div class="control-group">
						...
						<div class="controls">
							<textarea class="autogrow" style="height:30px;" id="a_note" name="note"></textarea>
						</div>
					</div>
...
<!-- 查看仪器设备信息弹出界面 start -->
<div class="modal hide fade viewInstrumentTableCss" id="viewInstrumentDiv">
	<div class="modal-header">
		<button type="button" class="close viewInstrumentCancel" data-dismiss="modal">×</button>
	...
	<table border="1" cellspacing="0" cellpadding="0">   
		...
		<tr>
			...
			<td class="InstrumentTitleCss">单价</td>
...
<script type="text/javascript" src="${pageContext.request.contextPath }/statics/localjs/instrumentManage.js"></script>
